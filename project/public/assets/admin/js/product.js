...
$("#variant-btn").on('click', function(){
    ...
    $("#variant-section").append(`<div class="variant-area">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <label>
                                            Variant Value :
                                            <span>
                                                (Enter Value againts Label)
                                            </span>
                                        </label>
                                        <input type="text" name="variant_value[]" class="input-field"
                                            placeholder="Variant Value" value="1" min="1">
                                    </div>
                                    <div class="col-md-4 col-sm-6">
                                        <label>
                                            Variant Price :
                                        ...
                                        <input type="text" name="variant_price[]" class="input-field"
                                            placeholder="Variant Price" value="0" min="0">
                                    </div>
                                </div>
                            </div>`);
...
$(document).on('click','.variant-remove', function(){
    ...
    $(this.parentNode).remove();
    if (isEmpty($('#variant-section'))) {

    $("#variant-section").append(`<div class="size-area">
                <span class="remove variant-remove"><i class="fas fa-times"></i></span>
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <label>
...
$("#variant-check").change(function() {
    if(this.checked) {
        $("#variant-display").show();
        // $("#stckprod").hide();
    }
    else
    {
        $("#variant-display").hide();
        // $("#stckprod").show();
