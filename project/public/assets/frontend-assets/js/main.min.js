	...
	function (t) {
		var e = {
			init: function () {
				...
				Wolmart.call(Wolmart.ratingTooltip, 500), Wolmart.call(Wolmart.setProgressBar(".progress-bar"), 500), this.initProductType("slideup"), this.initVariation(), this.initProductsScrollLoad(".scroll-load"), Wolmart.$body.on("mousedown", ".select-menu", function (e) {
				...
				}), Wolmart.$body.on("click", ".product-action .btn-cart", function (e) {
					e.preventDefault();
					...
					Wolmart.$body.on("click", ".product-single .btn-cart", function (e) {
						e.preventDefault();
						var qty = jQuery('.qttotal').val();
						...
						jQuery.ajax({
							...
							success: function (data) {
								...
								if (data == 'digital') {
									...
									jQuery("#cart-items").load(mainurl + '/carts/view');
									// toastr.success(langg.add_cart);
		...
		function o(e) {
			...
			if (a.hasClass("disabled")) alert("Please select some product options before adding this product to your cart.");
				...
				if (i.length) i.fadeOut(function () {
					...
					var o = '<div class="alert alert-success alert-cart-product mb-2">                            <a href="cart.html" class="btn btn-success btn-rounded">View Cart</a>                            <p class="mb-0 ls-normal">â€œ' + a.closest(".product-single").find(".product-title").text() + 'â€ has been added to your cart.</p>                            <a href="#" class="btn btn-link btn-close"><i class="close-icon"></i></a>                            </div>';
