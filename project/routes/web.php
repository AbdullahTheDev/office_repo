...
Route::get('testSquareup', function(){
...
Route::get('/products/delete/garbage', 'Admin\ProductController@deleteGarbage')->name('admin-delete-products-garbage');
Route::get('/insert/urls/', 'Admin\ProductController@RedirectUrls');
...
Route::prefix('admin')->group(function () {
  ...
  Route::post('/post-login', 'Admin\LoginController@login')->name('admin.login.submit');
  ...
  Route::group(['middleware' => 'permissions:orders'], function () {
    ...
    Route::get('/order/{id}/invoice/edit', 'Admin\OrderController@invoice_edit')->name('admin-order-invoice-edit');
    ...
    // Home Section
    Route::get('/homesection', 'Admin\HomeSectionController@index')->name("homesection");
    Route::get('/homesection_post', 'Admin\HomeSectionController@datatables')->name("homesection.datatables");
    Route::get('/homesection/add', 'Admin\HomeSectionController@create')->name("homesection.add");
    Route::post('/homesection/store', 'Admin\HomeSectionController@store')->name("homesection.store");
    Route::get('/homesection/edit/{id}', 'Admin\HomeSectionController@edit')->name("homesection.edit");
    Route::post('/homesection/update/{id}', 'Admin\HomeSectionController@update')->name("homesection.update");
    Route::get('/homesection/delete/{id}', 'Admin\HomeSectionController@destroy')->name("homesection.delete");
    // End Home Section
  });
  ...
  Route::group(['middleware' => 'permissions:categories'], function () {
    ...
    Route::get('/system_builder/datatables', 'Admin\SystemBuilderController@datatables')->name('system_builder-datatables'); //JSON REQUEST
    Route::get('/system_builder', 'Admin\SystemBuilderController@index')->name('system_builder-index');
    Route::get('/system_builder/create', 'Admin\SystemBuilderController@create')->name('system_builder-create');
    Route::post('/system_builder/create', 'Admin\SystemBuilderController@store')->name('system_builder-store');
    Route::get('/system_builder/edit/{id}', 'Admin\SystemBuilderController@edit')->name('system_builder-edit');
    Route::post('/system_builder/edit/{id}', 'Admin\SystemBuilderController@update')->name('system_builder-update');
    Route::get('/system_builder/delete/{id}', 'Admin\SystemBuilderController@destroy')->name('system_builder-delete');
    Route::get('/system_builder/status/{id1}/{id2}', 'Admin\SystemBuilderController@status')->name('system_builder-status');
  ...
  Route::group(['middleware' => 'permissions:home_page_settings'], function () {
    ...
    Route::get('/menu/datatables', 'Admin\MenuController@datatables')->name('admin-menu-datatables');
    ...
    Route::post('/menu/create', 'Admin\MenuController@store')->name('admin-menu-store');
    Route::get('/menu/edit/{id}', 'Admin\MenuController@edit')->name('admin-menu-edit');
    Route::post('/menu/edit/{id}', 'Admin\MenuController@update')->name('admin-menu-update');
    Route::get('/menu/delete/{id}', 'Admin\MenuController@destroy')->name('admin-menu-delete');
  ...
  Route::group(['middleware' => 'permissions:super'], function () {
    ...
    Route::get('/cache/clear', 'Admin\DashboardController@clear_cache')->name('admin-cache-clear');
...
Route::group(['middleware' => 'maintenance'], function () {
  ...
  Route::get('/user/guest', function () {
    if (!Auth::check()) {
      return view('front.authorization');
    }
  ...
  Route::post('/quote', 'Front\FrontendController@request_quote')->name('request.quote');
  Route::post('/sales/inquiry', 'Front\FrontendController@request_sale_inquiry')->name('request.sale_inquiry');
  ...
  // CATEGORY SECTION
  Route::get('/category/{category}', 'Front\CatalogController@main_category')->name('front.main_category');
  ...
  Route::get('/addcartcheckout/{id}', 'Front\CartController@addcartcheckout')->name('product.cart.add-checkout');
  ...
  Route::get('/checkout/get_ship', 'Front\CheckoutController@calcShipping')->name('front.load.shipping');
  ...
  Route::get('/get/states', 'Front\CheckoutController@getStates')->name('fetch.states');



  // CHECKOUT SECTION
  Route::get('/system_builder', 'Front\SystemBuilderController@index')->name('front.system_builder');
  ...
  // PAGE SECTION
  Route::get('/fedex', 'Front\FedexController@test');
