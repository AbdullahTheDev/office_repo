...
class GeniusMailer
{
    ...
    public function sendCustomMail(array $mailData,$id)
    {
        $setup = Generalsetting::find(1);
    ...
    public function sendQuoteMail(array $mailData)
    {
        $setup = Generalsetting::find(1);
    ...
    public function sendForgotPasswordMail(array $mailData)
    {
        $setup = Generalsetting::find(1);
    ...
    public function sendOrderStatusMail(array $mailData)
    {
        $setup = Generalsetting::find(1);
