...
class ProductController extends Controller
{
    ...
    public function createDigital()
    {
        ...
        $brands = Partner::all();
        $sign = Currency::where('is_default', '=', 1)->first();
        return view('vendor.product.create.digital', compact('cats', 'sign', 'brands'));
    }
    ...
    public function createLicense()
    {
        ...
        $brands = Partner::all();
        $sign = Currency::where('is_default', '=', 1)->first();
        return view('vendor.product.create.license', compact('cats', 'sign', 'brands'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($prods < $package->allowed_products || $package->allowed_products == 0) {
            ...
            if ($prod->type != 'Physical') {
                $prod->slug = strtolower(str_slug($data->name, '-')) . '-' . strtolower(str_random(3) . $data->id . str_random(3));
            } else {
                $prod->slug = strtolower(str_slug($data->name, '-')) . '-' . strtolower($data->sku);
            }
            // Set Photo
    ...
    public function edit($id)
    {
        ...
        elseif ($data->type == 'License')
            return view('vendor.product.edit.license', compact('cats', 'data', 'sign', 'brands'));
        else
