                        ...
                        <div class="view-order-page">
                            ...
                            <div class="print-order text-right">
                                <a href="{{route('user-order-print',$order->id)}}" target="_blank"
                                    class="print-order-btn btn btn-primary">
                            ...
                            <div class="billing-add-area">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <a id="tid" style="cursor: pointer;" class="mybtn2 btn btn-primary btn-sm">{{ $langg->lang297 }}</a> 
                            ...
                            <div class="table-responsive">
                                ...
                                <div class="edit-account-info-div">
                                    <div class="form-group">
                                        <a class="back-btn btn btn-info btn-sm" href="{{ route('user-orders') }}">{{ $langg->lang318 }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
