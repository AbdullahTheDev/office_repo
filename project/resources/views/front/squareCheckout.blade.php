...
<body>
    <form id="payment-form">
      ...
      <button id="card-button-2">Click</button>
     
      <form action="{{Route('payment.square')}}" id="form-submit" method="POST">
        ...
        // Step 5.2: create card payment
         ...
         // Call this function to send a payment token, buyer name, and other details
            ...
            async function createPayment(token) {
                ...
                const cardButton2 = document.getElementById('card-button-2');
