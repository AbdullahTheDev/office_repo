...
<section class="p-0 sub-categori">
...
<script>
  ...
  $(document).ready(function() {
    ...
    $(".attribute-input, #sortby, #display_prods").on('change', function() {
      $("#ajaxLoader").show();
      filter();
    });
  ...
  function filter() {
    ...
    if ($("#display_prods").val() != '') {
      if (filterlink == '') {
        filterlink += '{{route('front.category', [Request::route('category'), Request::route('subcategory'), Request::route('childcategory')])}}' + '?'+$("#display_prods").attr('name')+'='+$("#display_prods").val();
      } else {
        filterlink += '&'+$("#display_prods").attr('name')+'='+$("#display_prods").val();
      }
    }
