...
<hr>
                        ...
                        <input type="hidden" name="withdraw_fee" value="{{ $gs->withdraw_fee }}">
                        <input type="hidden" name="withdraw_charge" value="{{ $gs->withdraw_charge }}">
                        <!-- <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
 ...
 -->
                        ...
                        <input type="hidden" name="fixed_commission" value="{{ $gs->fixed_commission * $curr->value }}">
                        <input type="hidden" name="percentage_commission" value="{{ $gs->percentage_commission }}">
