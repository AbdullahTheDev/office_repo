                    ...
                    <div class="product-description">
                      <div class="body-area">
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Phone Number') }} *
                                  </h4>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="{{ __('Enter Phone Number Here') }}" name="phone" value="{{ $gs->phone }}" required="">
                          </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Sales Email') }} *
                                  </h4>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="{{ __('Enter Sales Email Address Here') }}" name="email1" value="{{ $gs->email1 }}" required="">
                          </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Support Email') }} *
                                  </h4>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="{{ __('Enter Support Email Address Here') }}" name="email2" value="{{ $gs->email2 }}" required="">
                          </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="col-lg-6">
                            <textarea class="input-field" placeholder="{{ __('Enter Address Here') }}" name="address" required="">{{ $gs->address }}</textarea>
                          </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="{{ __('Enter Working Hours Here') }}" name="working_hours" value="{{ $gs->working_hours }}" required="">
                          </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="col-lg-12">
                            <div class="text-editor">
                              <textarea name="policy" class="nic-edit-p">{{$gs->policy}}</textarea>
                            </div>
                          </div>
                        </div>
