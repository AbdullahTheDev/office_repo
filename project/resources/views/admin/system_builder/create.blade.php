                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('system_builder-create')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field nam" name="name" placeholder="{{ __("Enter Name") }}" required="" value="">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="number" class="input-field" name="sort" placeholder="{{ __("Enter Sorting Number") }}" required="" value="">
                          </div>
                        </div>
