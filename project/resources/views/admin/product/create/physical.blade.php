			...
			<div class="col-lg-12">
				...
				<ul class="links">
					...
					<li>
						...
						<a href="{{ url('admin/products') }}">{{ __('Add Product') }}</a>
					</li>
					<li>
							...
							<div class="body-area">
								...
								<div class="gocover"
									...
									<div class="row">
										...
										<div class="col-lg-12">
												<select name="brand_id" required="" class="input-field">
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<ul class="list">
												<li>
													<input name="variant_check" type="checkbox" id="variant-check" value="1">
													<label for="variant-check">{{ __('Add Product Variants') }}</label>
												</li>
											</ul>
										</div>
									</div>
									<div class="showbox" id="variant-display">
										<div class="row">
											<div class="col-lg-12">
											</div>
											<div class="col-lg-12">
														...
														<div class="row">
															...
															<div class="col-md-4 col-sm-6">
																...
																<input type="text" name="variant_value[]" class="input-field"
																	placeholder="{{ __('Variant Value') }}" value="1" min="1">
															</div>
															<div class="col-md-4 col-sm-6">
																<label>
																	{{ __('Variant Price') }} :
																...
																<input type="text" name="variant_price[]" class="input-field"
																	placeholder="{{ __('Variant Price') }}" value="0" min="0">
															</div>
														</div>
													</div>
												</div>
									...
									<!-- <div class="showbox"> -->
										...
										<div class="row">
											...
											<div class="col-lg-4">
												<input name="length" type="number" class="input-field" placeholder="Length (ex:20 )" step="Any" required>
											</div>
											<div class="col-lg-4">
												<input name="width" type="number" class="input-field" placeholder="Width (ex:20 )" step="Any" required>
											</div>
											<div class="col-lg-4">
												<input name="height" type="number" class="input-field" placeholder="Height (ex:20 )" step="Any" required>
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-lg-6">
												<input name="weight" type="text" class="input-field" placeholder="e.g 20">
											</div>
											<div class="col-lg-6">
												<select id="product_measure">
													<option value="">{{ __('None') }}</option>
													<option value="gm">{{ __('Gram') }}</option>
													<option value="kg">{{ __('Kilogram') }}</option>
													<option value="l">{{ __('Litre') }}</option>
													<option value="lbs">{{ __('Pound') }}</option>
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<div class="text-editor">
												<textarea class="nic-edit-p" name="specs"></textarea>
											</div>
										</div>
									</div>
