                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-cat-create')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div id="image-preview" class="img-preview" style="background: url({{ asset('assets/admin/images/upload.png') }});">
                                    ...
                                    <input type="file" name="photo" class="img-upload" id="image-upload">
							              ...
							              <div class="checkbox-wrapper">
							                <input type="checkbox" name="footer_link" id="footer_link" value="1">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <div class="checkbox-wrapper">
                              <input type="checkbox" name="header_link" id="header_link" value="1">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <div class="img-upload">
                                <div id="image-preview" class="img-preview" style="background: url({{ asset('assets/admin/images/upload.png') }});width: 100%;">
                                    <label for="image-upload" class="img-label" id="image-label"><i class="icofont-upload-alt"></i>{{ __('Upload Icon') }}</label>
