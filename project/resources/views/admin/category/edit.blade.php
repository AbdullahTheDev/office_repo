                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-cat-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <div class="checkbox-wrapper">
                              <input type="checkbox" name="footer_link" id="footer_link" value="1" {{ $data->footer_link != 0 ? "checked":"" }}>
                              <label for="footer_link">{{ __('Link to footer') }}</label>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <div class="checkbox-wrapper">
                              <input type="checkbox" name="header_link" id="header_link" value="1" {{ $data->header_link != 0 ? "checked":"" }}>
                              <label for="header_link">{{ __('Link to header') }}</label>
                            </div>
                          </div>
                        </div>
                        ...
                        <!-- <h3>Category Page Images</h3> -->
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Mega Menu Background Image') }} *</h4>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <div class="img-upload">
                                <div id="image-preview" class="img-preview" style="background: url({{ $data->img1 ? asset('assets/images/categories/'.$data->img1):asset('assets/images/noimage.png') }});width: 100%;">
                                    <label for="image-upload" class="img-label" id="image-label"><i class="icofont-upload-alt"></i>{{ __('Upload Image') }}</label>
                                    <input type="file" name="img1" class="img-upload" id="image-upload">
                                  </div>
                            </div>
                          </div>
                        </div>
