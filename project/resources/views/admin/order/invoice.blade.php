            ...
            <div class="row invoice__metaInfo mb-4">
                <div class="col-lg-6">
                    <div class="invoice__orderDetails">
                        ...
                        <span> <strong>{{ __('Shipping Charges') }} :</strong>
                            ${{ $order->ship_amount }}
                        </span><br>
                        @endif
           ...
           @if($order->dp == 0)
                <div class="col-lg-6">
                        <div class="invoice__shipping">
                           ...
                           <span><strong>{{ __('Zip Code') }}</strong>: {{ $order->shipping_zip == null ? $order->customer_zip : $order->shipping_zip }}</span>
                        </div>
                </div>
            ...
            @endif
                ...
                <div class="col-lg-6">
                        <div class="buyer">
                            ...
                            <span><strong>{{ __('Zip Code') }}</strong>: {{ $order->customer_zip }}</span>
                        </div>
                </div>
            </div>
                            ...
                            <div class="table-responsive">
                                <table id="example2" class="table table-hover dt-responsive" cellspacing="0"
                                    ...
                                    <thead>
                                        <tr>
                                            <th>{{ __('Product') }}</th>
                                            <th style="text-align: right;">{{ __('Details') }}</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: right;">{{$order->currency_sign}}{{ round($product['price'] * $order->currency_value , 2) }}
                                            </td>
                                            @php
                                    ...
                                    <tfoot>
                                        ...
                                        @endphp
                                            <tr>
                                                <td colspan="2">{{ $order->ship_name }}</td>
