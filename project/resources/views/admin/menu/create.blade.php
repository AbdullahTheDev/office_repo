                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-menu-create')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="number" class="input-field" name="sort" placeholder="{{ __('Enter Sorting Number') }}" value="">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="link_1" placeholder="{{ __('Image 1 Link') }}" value="">
                          </div>
                        </div>
                          ...
                          <div class="col-lg-7">
                            <div class="img-upload full-width-img">
                                <div id="image-preview" class="img-preview" style="background: url({{ asset('assets/admin/images/upload.png') }});">
                                  ...
                                  <p class="text">{{ __('Prefered Size: (248x400) or Square Sized Image') }}</p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="link_2" placeholder="{{ __('Image 2 Link') }}" value="">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <button class="addProductSubmit-btn mt-4" type="submit">{{ __('Create Menu') }}</button>
                          </div>
                        </div>
                      </form>
                      </div>
