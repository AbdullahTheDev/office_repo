...
@endif
	<link rel="stylesheet" href="{{asset('assets/front/css/gaahak.css')}}">
...
<body>
<input type="hidden" id="prev_url" value="{{Session::get("_previous")["url"]}}">
<input type="hidden" id="base_url" value="{{url('')}}">
@yield('home-preloader')
...
@endif
	...
	<section class="logo-header remove-padding">
		<div class="container">
			<div class="row ">
				<div class="col-lg-1 col-sm-6 col-5">
					<div class="logo">
				...
				<div class="col-lg-8 col-sm-12 order-last order-sm-2 order-md-2 ptb-20">
				...
				<div class="col-lg-3 col-sm-6 col-7 order-lg-last ptb-20">
					<div class="helpful-links">
						<ul class="helpful-links-inner">
							@if(!Auth::guard('web')->check())
							<li class="my-dropdown"  data-toggle="tooltip" data-placement="top" title="">
								<a href="{{url('user/login')}}" class="cart carticon">
									<div class="icon">
										{{ $langg->lang12 }} or {{ $langg->lang13 }}
									</div>
								</a>
							</li>
							@else
	...
	<div class="mainmenu-area mainmenu-bb">
		<div class="container">
			<div class="row align-items-center mainmenu-area-innner">
				...
				<div class="col-lg-12 col-md-6 mainmenu-wrapper remove-padding">
					<!-- <nav hidden>
    ...
    <div class="container row">
    	<div class="navbar-brand float-left categorimenu-wrapper col-lg-3 p-0">
    		<!--categorie menu start-->
					<div class="categories_menu">
						<div class="categories_title">
							<h2 class="categori_toggle"> {{ $langg->lang14 }} <i class="fa fa-caret-down arrow-down"></i></h2>
						</div>
        ...
        <div class="navbar-collapse collapse" id="main-nav-1">
            <ul class="navbar-nav mt-4m">
            	@if(!empty($main_menu))
            	@foreach($main_menu as $menu_item)
                <li class="nav-item dropdown position-static"><a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" data-target="#">{{$menu_item->name}}</a>
                    <!-- div.w-100 make it mega menu, div.top-auto opens the mega menu exactly as position like other normal menu -->
                    <div class="dropdown-menu w-100 top-auto mt-m2 animate slideIn">
                        <div class="container">
                            ...
                            <div class="row w-100 p-4">
                                <div class="col-2">
                                	<div class="mega-categories">
										...
										<ul>
											@forelse($menu_item->sub_categories() as $cat)
											<li>
												<a href="{{ route('front.subcat',['slug1' => $cat->category->slug, 'slug2' => $cat->slug]) }}">{{$cat->name}}</a>
											</li>
											@empty
                                ...
                                <div class="col-4">
                                	<div class="mega-brands">
										...
										<div class="row">
											@forelse($menu_item->brands() as $brand)
											<a href="{{ route('front.category',['category'=>$menu_item->cat()->slug]) }}?brand={{$brand->id}}" class="col-4">
												<img src="{{asset('assets/images/partner/'.$brand->photo)}}" alt="brand" >
											</a>
											@empty
                                ...
                                <div class="col-4 mega-bg-img" style="background: url({{asset('assets/images/menu/'.$menu_item->img_1)}});" onclick="location.href='{{$menu_item->link_1}}'">
                                </div>
                                <div class="col-2 mega-bg-img" style="background: url({{asset('assets/images/menu/'.$menu_item->img_2)}});" onclick="location.href='{{$menu_item->link_2}}'">
                                </div>
                            </div>
                        </div>
                    </div>
...
@yield('content')
	...
	<!-- Footer Top End -->
	<!-- Footer Area Start -->
	<footer class="footer" id="footer" style="background: <?= $gs->footer_color ?>">
		<div class="container">
			<div class="row">
				@if(!empty($footers))
				...
				<div class="col-lg-2">
					<h4>{{$footer->name}}</h4>
					<ul>
						@if(!empty($footer->subs))
						@foreach($footer->subs as $sub)
						<li>
							<a href="{{ route('front.subcat',['slug1' => $sub->category->slug, 'slug2' => $sub->slug]) }}" class="f-link">{{$sub->name}}</a>
						</li>
						@endforeach
						@endif
					</ul>
			...
			<div class="row apps-contact">
				...
				<div class="col-lg-6 fotter-social-links">
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-6">
						<div class="content">
							<div class="content">
								<p>{!! $gs->copyright !!} <img src="{{asset('assets/front/images/gaahak-payments.png')}}"></p>
							</div>
						</div>
					</div>
					<div class="col-lg-6">
						<div class="content">
							<div class="content footer-links">
								...
								@endforeach
									...
									<a href="{{ url('system_builder') }}"> System Builder </a>
							</div>
						</div>
					</div>
				</div>
